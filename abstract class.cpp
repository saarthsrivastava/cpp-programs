...
{   private:
    ...
    public:
	   ...
	   virtual double deposit(double amount)=0;//pure virtual class.it does not have any implementation.they cannot instantiate objects.it is also called abstract
	 /*  {
